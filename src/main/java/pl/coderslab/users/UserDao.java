...
public class UserDao {
    ...
    private static final String DELETE_QUERY = "DELETE FROM workshop3.users where id = ?";
    private static final String READ_QUERY="SELECT * FROM  users where id=?";
    public static final String UPDATE_USER_QUERY= "UPDATE workshop3.users SET username = ?, email = ?, password = ? WHERE id = ?;";
    public static final String READ_ALL_QUERY="select  * from workshop3.users;";
